        ...
        <div className="home">
            ...
            >
                <div className="typography-lines">
                    <div className="line ascender">
                        <span>Ascender</span>
                    </div>
                    <div className="line cap-height">
                        <span>Cap Height</span>
                    </div>
                    <div className="line x-height">
                        <span>X Height</span>
                    </div>
                    <div className="line baseline">
                        <span>Baseline</span>
                    </div>
                    <div className="line descender">
                        <span>Descender</span>
                    </div>
                </div>
                ...
                <div className="hero-content" style={style}>
                    {activeAnimation === 0 && (
                        <TypeAnimation
                            ...
                            sequence={["Intuitive", 2000, () => setActiveAnimation(1)]}
                        />
                    )}
                    {activeAnimation === 1 && (
                        <TypeAnimation
                            ...
                            sequence={["Creative", 2000, () => setActiveAnimation(2)]}
                        />
                    )}
                    {activeAnimation === 2 && (
                        <TypeAnimation
                            ...
                            sequence={["Systematic", 2000, () => setActiveAnimation(0)]}
                        />
                    )}
                </div>
            </section>
            ...
            <section className="video-demo-section" ref={videoSectionRef}>
                <p className="video-demo-title">
                    ...
                    forms. Percent makes it less intimidating to try font design for designers and
                    encourages creative exploration as well as learning.
                </p>
                <div className="video-container">
                    <div className="video-item">
                        ...
                        <div className="video-description">
                            <h4>Adjust</h4>
                            <p>
                                By allowing circle manipulation (changing the circle width and
                                location), the user is able to update glyph forms.
                            </p>
                        </div>
                    </div>
                    <div className="video-item">
                        ...
                        <div className="video-description">
                            <h4>System</h4>
                            <p>
                                Percent makes it less intimidating to try font design for designers
