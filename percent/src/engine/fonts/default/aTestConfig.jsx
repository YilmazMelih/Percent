...
let fun = findClosestPointOnPathTowardFill;

const skeletonEndpoints = {
    point1: fun(points.point1, aSkeleton, defaultAPath),
    point2: fun(points.point2, aSkeleton, defaultAPath),
    point3: fun(points.point3, aSkeleton, defaultAPath),
    point4: fun(points.point4, aSkeleton, defaultAPath),
    point5: fun(points.point5, aSkeleton, defaultAPath),
    point6: fun(points.point6, aSkeleton, defaultAPath),
    point7: fun(points.point7, aSkeleton, defaultAPath),
    point8: fun(points.point8, aSkeleton, defaultAPath),
    point9: fun(points.point9, aSkeleton, defaultAPath),
    point10: fun(points.point10, aSkeleton, defaultAPath),
    point11: fun(points.point11, aSkeleton, defaultAPath),
    point12: fun(points.point12, aSkeleton, defaultAPath),
    point13: fun(points.point13, aSkeleton, defaultAPath),
    point14: fun(points.point14, aSkeleton, defaultAPath),
    point15: fun(points.point15, aSkeleton, defaultAPath),
    point16: fun(points.point16, aSkeleton, defaultAPath),
    point17: fun(points.point17, aSkeleton, defaultAPath),
    point18: fun(points.point18, aSkeleton, defaultAPath),
    point19: fun(points.point19, aSkeleton, defaultAPath),
    point20: fun(points.point20, aSkeleton, defaultAPath),
    point21: fun(points.point21, aSkeleton, defaultAPath),
    point22: fun(points.point22, aSkeleton, defaultAPath),
    point23: fun(points.point23, aSkeleton, defaultAPath),
    point24: fun(points.point24, aSkeleton, defaultAPath),
    point25: fun(points.point25, aSkeleton, defaultAPath),
    point26: fun(points.point26, aSkeleton, defaultAPath),
    point27: fun(points.point27, aSkeleton, defaultAPath),
    point28: fun(points.point28, aSkeleton, defaultAPath),
    point29: fun(points.point29, aSkeleton, defaultAPath),
    point30: fun(points.point30, aSkeleton, defaultAPath),
    point31: fun(points.point31, aSkeleton, defaultAPath),
    point32: fun(points.point32, aSkeleton, defaultAPath),
    point33: fun(points.point33, aSkeleton, defaultAPath),
    point34: fun(points.point34, aSkeleton, defaultAPath),
    point35: fun(points.point35, aSkeleton, defaultAPath),
    point36: fun(points.point36, aSkeleton, defaultAPath),
    point37: fun(points.point37, aSkeleton, defaultAPath),
    point38: fun(points.point38, aSkeleton, defaultAPath),
    point39: fun(points.point39, aSkeleton, defaultAPath),
    point40: fun(points.point40, aSkeleton, defaultAPath),
    point41: fun(points.point41, aSkeleton, defaultAPath),
    point42: fun(points.point42, aSkeleton, defaultAPath),
};
